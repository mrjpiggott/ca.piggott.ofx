...
public class OFXAvailableBalance implements OFXObject, IOFXBalance {
	...
	/* (non-Javadoc)
	 * @see ca.piggott.ofx.internal.model.IOFXAvailableBalance#setDate(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.piggott.ofx.internal.model.IOFXAvailableBalance#getDate()
	 */
	@Override
	public Date getDate() {
		return date;
	...
	/* (non-Javadoc)
	 * @see ca.piggott.ofx.internal.model.IOFXAvailableBalance#setBalance(java.math.BigDecimal)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ca.piggott.ofx.internal.model.IOFXAvailableBalance#getBalance()
	 */
	@Override
